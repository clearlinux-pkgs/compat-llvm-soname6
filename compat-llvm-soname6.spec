...
Source4 : http://releases.llvm.org/6.0.1/llvm-6.0.1.src.tar.xz.sig
...
Requires: compat-llvm-soname6 = %{version}-%{release}
...
mkdir -p tools/clang
cp -r %{_topdir}/BUILD/cfe-6.0.1.src/* %{_topdir}/BUILD/llvm-6.0.1.src/tools/clang
mkdir -p tools/lld
cp -r %{_topdir}/BUILD/lld-6.0.1.src/* %{_topdir}/BUILD/llvm-6.0.1.src/tools/lld
mkdir -p projects/openmp
cp -r %{_topdir}/BUILD/openmp-6.0.1.src/* %{_topdir}/BUILD/llvm-6.0.1.src/projects/openmp
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567824900
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
export SOURCE_DATE_EPOCH=1567824900
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/compat-llvm-soname6
cp LICENSE.TXT %{buildroot}/usr/share/package-licenses/compat-llvm-soname6/LICENSE.TXT
cp projects/openmp/LICENSE.txt %{buildroot}/usr/share/package-licenses/compat-llvm-soname6/projects_openmp_LICENSE.txt
cp test/YAMLParser/LICENSE.txt %{buildroot}/usr/share/package-licenses/compat-llvm-soname6/test_YAMLParser_LICENSE.txt
cp tools/clang/LICENSE.TXT %{buildroot}/usr/share/package-licenses/compat-llvm-soname6/tools_clang_LICENSE.TXT
cp tools/clang/tools/clang-format-vs/ClangFormat/license.txt %{buildroot}/usr/share/package-licenses/compat-llvm-soname6/tools_clang_tools_clang-format-vs_ClangFormat_license.txt
cp tools/lld/LICENSE.TXT %{buildroot}/usr/share/package-licenses/compat-llvm-soname6/tools_lld_LICENSE.TXT
cp utils/unittest/googlemock/LICENSE.txt %{buildroot}/usr/share/package-licenses/compat-llvm-soname6/utils_unittest_googlemock_LICENSE.txt
cp utils/unittest/googletest/LICENSE.TXT %{buildroot}/usr/share/package-licenses/compat-llvm-soname6/utils_unittest_googletest_LICENSE.TXT
pushd clr-build
%make_install
popd
...
rm -f %{buildroot}/usr/bin/clang++
rm -f %{buildroot}/usr/bin/clang-apply-replacements
rm -f %{buildroot}/usr/bin/clang-change-namespace
...
rm -f %{buildroot}/usr/bin/clang-include-fixer
rm -f %{buildroot}/usr/bin/clang-offload-bundler
rm -f %{buildroot}/usr/bin/clang-query
rm -f %{buildroot}/usr/bin/clang-refactor
rm -f %{buildroot}/usr/bin/clang-rename
rm -f %{buildroot}/usr/bin/clang-reorder-fields
rm -f %{buildroot}/usr/bin/clang-tidy
rm -f %{buildroot}/usr/bin/clangd
rm -f %{buildroot}/usr/bin/count
rm -f %{buildroot}/usr/bin/find-all-symbols
...
rm -f %{buildroot}/usr/bin/modularize
...
rm -f %{buildroot}/usr/share/clang/clang-include-fixer.el
rm -f %{buildroot}/usr/share/clang/clang-include-fixer.py
rm -f %{buildroot}/usr/share/clang/clang-rename.el
rm -f %{buildroot}/usr/share/clang/clang-rename.py
rm -f %{buildroot}/usr/share/clang/clang-tidy-diff.py
rm -f %{buildroot}/usr/share/clang/run-clang-tidy.py
rm -f %{buildroot}/usr/share/clang/run-find-all-symbols.py
...
rm -f %{buildroot}/usr/include/llvm/CodeGen/CommandFlags.def
...
rm -f %{buildroot}/usr/include/llvm/CodeGen/RuntimeLibcalls.def
...
rm -f %{buildroot}/usr/include/llvm/CodeGen/TargetLoweringObjectFile.h
rm -f %{buildroot}/usr/include/llvm/CodeGen/TargetLoweringObjectFileImpl.h
rm -f %{buildroot}/usr/include/llvm/CodeGen/TargetOpcodes.def
...
rm -f %{buildroot}/usr/include/llvm/MC/MCTargetOptionsCommandFlags.def
...
rm -f %{buildroot}/usr/include/llvm/Support/AMDGPUKernelDescriptor.h
...
rm -f %{buildroot}/usr/lib64/libLLVMBPFAsmParser.so
...
rm -f %{buildroot}/usr/lib64/libLLVMFuzzMutate.so
...
rm -f %{buildroot}/usr/lib64/libLLVMWindowsManifest.so
...
rm -f %{buildroot}/usr/lib64/libclangApplyReplacements.so
rm -f %{buildroot}/usr/lib64/libclangBasic.so
rm -f %{buildroot}/usr/lib64/libclangChangeNamespace.so
rm -f %{buildroot}/usr/lib64/libclangCodeGen.so
rm -f %{buildroot}/usr/lib64/libclangCrossTU.so
rm -f %{buildroot}/usr/lib64/libclangDaemon.so
...
rm -f %{buildroot}/usr/lib64/libclangIncludeFixer.so
rm -f %{buildroot}/usr/lib64/libclangIncludeFixerPlugin.so
rm -f %{buildroot}/usr/lib64/libclangIndex.so
rm -f %{buildroot}/usr/lib64/libclangLex.so
rm -f %{buildroot}/usr/lib64/libclangMove.so
rm -f %{buildroot}/usr/lib64/libclangParse.so
rm -f %{buildroot}/usr/lib64/libclangQuery.so
rm -f %{buildroot}/usr/lib64/libclangReorderFields.so
...
rm -f %{buildroot}/usr/lib64/libclangTidy.so
rm -f %{buildroot}/usr/lib64/libclangTidyAndroidModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyBoostModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyBugproneModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyCERTModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyCppCoreGuidelinesModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyFuchsiaModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyGoogleModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyHICPPModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyLLVMModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyMPIModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyMiscModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyModernizeModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyObjCModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyPerformanceModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyPlugin.so
rm -f %{buildroot}/usr/lib64/libclangTidyReadabilityModule.so
rm -f %{buildroot}/usr/lib64/libclangTidyUtils.so
...
rm -f %{buildroot}/usr/lib64/libfindAllSymbols.so
rm -f %{buildroot}/usr/lib64/libgomp.so
rm -f %{buildroot}/usr/lib64/libiomp5.so
rm -f %{buildroot}/usr/lib64/liblldCOFF.so
rm -f %{buildroot}/usr/lib64/liblldCommon.so
rm -f %{buildroot}/usr/lib64/liblldCore.so
rm -f %{buildroot}/usr/lib64/liblldDriver.so
rm -f %{buildroot}/usr/lib64/liblldELF.so
rm -f %{buildroot}/usr/lib64/liblldMachO.so
rm -f %{buildroot}/usr/lib64/liblldMinGW.so
rm -f %{buildroot}/usr/lib64/liblldReaderWriter.so
rm -f %{buildroot}/usr/lib64/liblldWasm.so
rm -f %{buildroot}/usr/lib64/liblldYAML.so
...
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/LICENSE.TXT
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/projects_openmp_LICENSE.txt
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/test_YAMLParser_LICENSE.txt
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/tools_clang_LICENSE.TXT
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/tools_clang_tools_clang-format-vs_ClangFormat_license.txt
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/tools_extra_LICENSE.TXT
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/tools_extra_clang-tidy-vs_ClangTidy_license.txt
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/tools_extra_clang-tidy_cert_LICENSE.TXT
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/tools_extra_clang-tidy_hicpp_LICENSE.TXT
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/tools_extra_clangd_clients_clangd-vscode_LICENSE
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/tools_lld_LICENSE.TXT
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/utils_unittest_googlemock_LICENSE.txt
rm -f %{buildroot}/usr/share/doc/compat-llvm-soname6/utils_unittest_googletest_LICENSE.TXT
...
/usr/share/package-licenses/compat-llvm-soname6/LICENSE.TXT
/usr/share/package-licenses/compat-llvm-soname6/projects_openmp_LICENSE.txt
/usr/share/package-licenses/compat-llvm-soname6/test_YAMLParser_LICENSE.txt
/usr/share/package-licenses/compat-llvm-soname6/tools_clang_LICENSE.TXT
/usr/share/package-licenses/compat-llvm-soname6/tools_clang_tools_clang-format-vs_ClangFormat_license.txt
/usr/share/package-licenses/compat-llvm-soname6/tools_lld_LICENSE.TXT
/usr/share/package-licenses/compat-llvm-soname6/utils_unittest_googlemock_LICENSE.txt
/usr/share/package-licenses/compat-llvm-soname6/utils_unittest_googletest_LICENSE.TXT
